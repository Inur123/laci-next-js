          ...
          <div className="p-8 space-y-8">
            <div className="grid gap-8">
              ...
              <div className="space-y-4 pt-6 border-t">
                ...
                <div className="bg-amber-50/50 border border-amber-100 p-4 rounded-lg flex items-start gap-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-amber-700 leading-relaxed">
                      Sebagai Sekretaris Cabang, Anda memiliki wewenang penuh
                      untuk mengelola akses pengguna ini ke dalam sistem Laci.
                    </p>
                  </div>
                </div>
                ...
                <div className="grid gap-3 pt-2 sm:grid-cols-2">
                  <Button
                    variant="outline"
                    className={`h-12 text-sm font-semibold transition-all shadow-sm cursor-pointer ${
                      currentUser.isActive
                        ? "text-amber-600 border-amber-200 hover:bg-amber-100/50 hover:border-amber-300"
                        : "text-green-600 border-emerald-200 hover:bg-emerald-100/50 hover:border-emerald-300"
                    }`}
                  ...
                  <Button
                    variant="outline"
                    className="h-12 text-sm font-semibold text-slate-600 border-slate-200 hover:bg-slate-100/50 hover:border-slate-300 transition-all shadow-sm cursor-pointer"
                ...
                <div className="pt-4 mt-4 border-t border-dashed">
                  <Button
                    variant="outline"
                    className="w-full h-12 text-sm font-semibold text-red-600 border-red-200 hover:bg-red-100/50 hover:border-red-300 transition-all shadow-sm cursor-pointer"
                  ...
                  <p className="text-[10px] text-center text-slate-400 mt-3 italic tracking-tight">
                    * Perhatian: Menghapus akun akan menghilangkan seluruh data
                    terkait user ini dari database.
                  </p>
                </div>
              </div>
            </div>
